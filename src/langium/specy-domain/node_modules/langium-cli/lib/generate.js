...
export async function runGenerator(config, options) {
    ...
    for (const grammar of embeddedGrammars) {
        ...
        if (languageConfig === null || languageConfig === void 0 ? void 0 : languageConfig.bnf) {
            const genBnf = generateBnf([grammar], {
                dialect: (_c = languageConfig.bnf.dialect) !== null && _c !== void 0 ? _c : 'GBNF',
                commentStyle: languageConfig.bnf.comment
            });
            const bnfPath = path.resolve(relPath, (_d = languageConfig.bnf.out) !== null && _d !== void 0 ? _d : `${(_e = grammar.name) !== null && _e !== void 0 ? _e : 'grammar'}.gbnf`);
