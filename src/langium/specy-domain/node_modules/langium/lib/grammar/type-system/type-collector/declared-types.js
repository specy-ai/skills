...
export function collectDeclaredTypes(interfaces, unions, services) {
    ...
    for (const type of interfaces) {
        ...
        for (const attribute of type.attributes) {
            const property = {
                ...
                comment: commentProvider === null || commentProvider === void 0 ? void 0 : commentProvider.getComment(attribute)
            };
        ...
        const interfaceType = {
            ...
            subTypes: new Set(),
            comment: commentProvider === null || commentProvider === void 0 ? void 0 : commentProvider.getComment(type),
        };
    ...
    for (const union of unions) {
        const unionType = {
            ...
            superTypes: new Set(),
            subTypes: new Set(),
            comment: commentProvider === null || commentProvider === void 0 ? void 0 : commentProvider.getComment(union),
        };
