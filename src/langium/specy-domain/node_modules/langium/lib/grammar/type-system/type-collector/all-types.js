...
///////////////////////////////////////////////////////////////////////////////
export function collectAllAstResources(grammars, visited = new Set(), astResources = { parserRules: [], datatypeRules: [], interfaces: [], types: [] }, services) {
    ...
    for (const grammar of grammars) {
        ...
        const documents = services === null || services === void 0 ? void 0 : services.shared.workspace.LangiumDocuments;
        if (documents) {
