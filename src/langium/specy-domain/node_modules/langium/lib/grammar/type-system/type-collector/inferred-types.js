...
export function collectInferredTypes(parserRules, datatypeRules, declared, services) {
    const commentProvider = services === null || services === void 0 ? void 0 : services.documentation.CommentProvider;
    ...
    for (const rule of parserRules) {
        const comment = commentProvider === null || commentProvider === void 0 ? void 0 : commentProvider.getComment(rule);
        allTypes.push(...getRuleTypes(context, rule, services).map(typePath => (Object.assign(Object.assign({}, typePath), { comment }))));
    }
    ...
    for (const rule of datatypeRules) {
        ...
        astTypes.unions.push({
            ...
            comment: commentProvider === null || commentProvider === void 0 ? void 0 : commentProvider.getComment(rule),
        });
    }
    return astTypes;
}
...
function addAction(graph, parent, action, services) {
    ...
    if (action.feature && action.operator) {
        ...
        typeNode.properties.push({
            ...
            comment: commentProvider === null || commentProvider === void 0 ? void 0 : commentProvider.getComment(action),
        });
    }
    return typeNode;
}
function addAssignment(current, assignment, services) {
    ...
    current.properties.push({
        ...
        comment: commentProvider === null || commentProvider === void 0 ? void 0 : commentProvider.getComment(assignment),
    });
}
...
function flattenTypes(alternatives, part) {
    ...
    for (const [name, namedAlternatives] of nameToAlternatives.entriesGroupedByKey()) {
        ...
        for (const path of namedAlternatives) {
            const alt = path.alt;
            (_a = type.comment) !== null && _a !== void 0 ? _a : (type.comment = path.comment);
            (_b = (_c = type.alt).comment) !== null && _b !== void 0 ? _b : (_c.comment = path.comment);
