...
export class LangiumGrammarCodeActionProvider {
    ...
    replaceRule(rule) {
        var _a;
        const type = (_a = rule.inferredType) !== null && _a !== void 0 ? _a : rule;
        return type.name;
    }
    ...
    replaceParserRuleByTypeDeclaration(diagnostic, document) {
        ...
        if (rootCst) {
            ...
            const rule = getContainerOfType(cstNode === null || cstNode === void 0 ? void 0 : cstNode.astNode, ast.isParserRule);
