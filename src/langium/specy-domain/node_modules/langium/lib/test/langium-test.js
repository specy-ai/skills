...
export function validationHelper(services) {
    ...
    return async (input, options) => {
        var _a, _b;
        const parseOptions = Object.assign({}, (options !== null && options !== void 0 ? options : {}));
        (_a = parseOptions.validation) !== null && _a !== void 0 ? _a : (parseOptions.validation = true);
        const document = await parse(input, parseOptions);
        const result = {
            document,
            diagnostics: (_b = document.diagnostics) !== null && _b !== void 0 ? _b : [],
...
export function testCodeAction(services) {
    ...
    return async (input, diagnosticCode, outputAfterFix, options) => {
        ...
        const diagnosticsAll = (_a = document.diagnostics) !== null && _a !== void 0 ? _a : [];
        ...
        const currentActions = await actionProvider.getCodeActions(document, Object.assign(Object.assign({}, textDocumentParams(document)), { range: diagnosticRelevant.range, context: {
        ...
        if (outputAfterFix) {
            ...
            const edits = expectTruthy((_b = action.edit) === null || _b === void 0 ? void 0 : _b.changes[document.textDocument.uri]);
        ...
        async function dispose() {
            ...
            validationAfter === null || validationAfter === void 0 ? void 0 : validationAfter.dispose();
        }
        return {
            document,
            diagnosticsAll,
