...
export class DefaultWorkspaceManager {
    ...
    async performStartup(folders) {
        ...
        const fileNames = this.serviceRegistry.all.flatMap(e => { var _a; return (_a = e.LanguageMetaData.fileNames) !== null && _a !== void 0 ? _a : []; });
        const documents = [];
     ...
     */
    async traverseFolder(workspaceFolder, folderPath, selector, collector) {
